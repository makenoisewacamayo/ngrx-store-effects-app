  ...
  describe('LoadPizzas Actions', () => {
    describe('LoadPizzas', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.LOAD_PIZZAS});
      });
    });
    ...
    describe('LoadPizzasFail', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.LOAD_PIZZAS_FAIL, payload});
      });
    });
    ...
    describe('LoadPizzasSuccess', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.LOAD_PIZZAS_SUCCESS, payload});
      });
    });
  });
  ...
  describe('CreatePizza Actions', () => {
    describe('CreatePizza', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.CREATE_PIZZA, payload});
      });
    });
    ...
    describe('CreatePizzaFail', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.CREATE_PIZZA_FAIL, payload});
      });
    });
    ...
    describe('CreatePizzaSuccess', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.CREATE_PIZZA_SUCCESS, payload});
      });
    });
  });
  ...
  describe('UpdatePizza Actions', () => {
    describe('UpdatePizza', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.UPDATE_PIZZA, payload});
      });
    });
    ...
    describe('UpdatePizzaFail', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.UPDATE_PIZZA_FAIL, payload});
      });
    });
    ...
    describe('UpdatePizzaSuccess', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.UPDATE_PIZZA_SUCCESS, payload});
      });
    });
  });
  ...
  describe('RemovePizza Actions', () => {
    describe('RemovePizza', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.REMOVE_PIZZA, payload});
      });
    });
    ...
    describe('RemovePizzaFail', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.REMOVE_PIZZA_FAIL, payload});
      });
    });
    ...
    describe('RemovePizzaSuccess', () => {
      it('should create an action', () => {
        ...
        expect({
          ...action
        }).toEqual({type: fromPizzas.REMOVE_PIZZA_SUCCESS, payload});
      });
    });
  });
});
